package io.github.ilyalevelev.examples.reference;

// This import lets us use classes from java.util package (List, Map, etc.)
import java.util.*;

/**
 * Summary of the basic concepts of a programming language.
 * (Note: this is a class comment)
 */
public class ProgrammingBasicConcepts {

	/** 
	 * The main method is where the program starts.
	 * (Note: this is a function/method comment)
	 */
